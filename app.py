...
LANGS = {
    "en": {
        ...
        "intro": "Merge multiple PDF files from a single .rar archive with a clean and simple workflow.",
    ...
    "pt": {
        ...
        "intro": "Mescle múltiplos arquivos PDF a partir de um único arquivo .rar com um fluxo limpo e simples.",
    ...
    if uploaded_file is None:
        ...
        with st.spinner(T["processing"]):
            try:
                ...
                st.success(
                    T["success"].format(
                        n=len(st.session_state["lista_pdfs"])
                    )
                )
